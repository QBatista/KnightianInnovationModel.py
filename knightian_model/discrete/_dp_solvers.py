...
def solve_dp_vi(V1_star, V1_store, V2_star, V2_store, states_vals, δ_vals, π,
    ...
    method : scalar(int)
        Integer representing the method to be used for solving maximization
        problems.
        ::
    ...
    if method == 0:  # Brute force
        ...
        for num_iter in range(1, maxiter + 1):
            ...
            fp1, sup_norm1 = _check_approx_fixed_point(V1_star, V1_store, tol)
            fp2, sup_norm2 = _check_approx_fixed_point(V2_star, V2_store, tol)
